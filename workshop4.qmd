...
Now we have the linear model, if we have some some pNP absorbance values, we can determine of the pNPP enzyme concentrations. We have put some mock pNP values in the excel file `example_alkaline_phosphatase_activity_assay-2024-03-21.xlsx`, in sheet two.
...
Each experiment will have a slightly different number of cells, and this will affect the amount of the para-nitrophenyl phosphate (pNPP) enzyme, and therefore the amount of pNP product produced.
