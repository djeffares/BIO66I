...
First, read in some ata from an Excel file. You can obtain [an example file from here](https://djeffares.github.io/BIO66I/example_alkaline_phosphatase_activity_assay_DNA_Lab.xlsx). Click to download, and then save the file in your **raw-data** directory. If you don't have a **raw-data** directory, make one!
