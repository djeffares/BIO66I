...
The methods we use to examine cells moving on *x* and *x* coordinates would be used any location data that tracks objects objects in a two-dimensional plane over time; traffic, birds, slugs, people*.
* with consent
:::
...
First, read in some ata from an Excel file.
