...
First, read in some ata from an Excel file. You can obtain [an example file from here](https://djeffares.github.io/BIO66I/example_alkaline_phosphatase_activity_assay-2024-03-21.xlsx). Click to download, and then save the file in your **raw-data** directory. If you dno't have a **raw-data** directory, make one!
...
mock <- mock |> 
  ...
  select(-absorb.rep1, -absorb.rep2, -absorb.rep3)
```
...
#As a new column
mock$predicted.pNP.concs = predicted.pNP.concs
...
Later, we will update this page to include some analysis.
