...
```{r}
write_tsv(trackingid.small.data, file ="/Users/dj757/gd/modules/BIO66I/docs/data/")
```
...
First load the small data

#trackingid.small.datahttps://djeffares.github.io/BIO66I/data/trackingid.small.data.tsv
