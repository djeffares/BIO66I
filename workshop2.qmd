...
::: callout-important
## If there is something you don't understand, it's OK to ask us!
:::
...
It is also valuable to learn how to make plots and analyse small data sets, as well as large ones. So now we will create a very small subset of the data, and investigate this.
...
The `geom_jitter` with the large data set looks *terrible*! This is not a good way to show this data. So remove this part of the plot, and try again. You may also want to try using `geom_violin` instead of `geom_boxplot`. 
...
- What did making the plots do that summary statistics (like average, or median) cannot do?
